...
function setup() {
  ...
  //Third level
  block13=new Box3(360+60,195,30,40);
  block14=new Box3(390+60,195,30,40);
  block15=new Box3(420+60,195,30,40);
  
  //Fouth level
  block16=new Box4(390+60,155,30,40);
  ...
  //Middle level 
  block22=new Box3(800-30,205-40,30,40);
  block23=new Box3(800,205-40,30,40);
  block24=new Box3(800+30,205-40,30,40);

  //Top level
  block25=new Box2(800,205-80,30,40);
...
function draw() {
  ...
  fill("black");
  textSize(22);
  text("Drag the Hexagonal Stone and Release it to break the Building",150,30);
